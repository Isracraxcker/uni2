import { ArrowLeft, SparklesIcon, TextIcon, Upload } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        >
          {mode === "text" && (
            <textarea
              ...
              placeholder="¿Qué está pensando?"
        ...
        <button
          onClick={() =>
            toast.promise(handleCreateStory(), {
              loading: "Subiendo historia...",
              success: <p>Historia subida con éxito</p>,
        ...
        >
          <SparklesIcon size={18} /> Subir Historia
        </button>
      </div>
    </div>
  );
