...
const Connections = () => {
  const [currentTab, setCurrentTab] = useState("Seguidores");
  const navigate = useNavigate();

  const dataArray = [
    { label: "Seguidores", value: followers, icon: Users },
    { label: "Seguidos", value: following, icon: UserCheck },
    { label: "Pendientes", value: pendingConnections, icon: UserRoundPen },
    { label: "Conexiones", value: connections, icon: UserPlus },
  ];
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">Manage your connections and messages</p>
        </div>
          ...
          {dataArray.map((tab) => (
            ...
            >
              ...
              {tab.count !== undefined && (
                <span
                  className="
                ml-2 text-xs bg-gray-100 text-gray-700 px-2 py-0.5 rounded-full
                "
                >
                  {tab.count}
                </span>
