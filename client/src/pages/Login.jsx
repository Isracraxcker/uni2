...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      {/* left side : Branding */}
      <div className="flex-1 flex flex-col items-start justify-between p-6 nd:p-10 lg:pl-40">
        <img
          src={assets.logo}
          alt="Uni2 Logo"
        ...
        <div>
          ...
          <h1 className="text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent">
            Más que solo amigos: una conexión verdadera.
          </h1>
          <p className="text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md">
            En Uni2, conectemos a personas que comparten tus mismas pasiones.
          </p>
        </div>
